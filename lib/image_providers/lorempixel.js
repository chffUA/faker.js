...
var Lorempixel = function (faker) {
  ...
  var self = this;
  self.categories = ["abstract", "animals", "business", "cats", "city", "food", "nightlife", "fashion", "people", "nature", "sports", "technics", "transport"];
  ...
  self.imageUrl = function (width, height, category, randomize, https) {
      ...
      var protocol = 'http://';
      var url ='lorempixel.com';
      
      if (typeof https !== 'undefined' && https === true) {
        protocol = 'https://';
      }

      url = protocol + url + "/" + width + '/' + height;
